 ...
 * masquerading with a partner admin access codes
 */

describe("logging in as super admin and masquerade with partner admin access codes", () => {
  before(function () {
    cy.login(this.testData.users.super_admin)
  })

  specify("it can masquerade partner admin with access codes", function () {
    cy.get("div[data-cy=super-admin-banner]")
      .find("input")
      .type(this.testData.users.partner_admin_access_codes.username)
    cy.get("div[data-cy=super-admin-banner]")
