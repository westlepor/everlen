...
describe("logging in as super admin and masquerade with HCP client admin", () => {
  before(function () {
    cy.login(this.testData.users.super_admin)
  })

  specify("it can masquerade HCP client admin", function () {
    cy.get("div[data-cy=super-admin-banner]")
      .find("input")
      .type(this.testData.users.client_admin_hcp.username)
    cy.get("div[data-cy=super-admin-banner]")
