/*
 * This tests login in as a multiple client admin
 * and checks the create access code page.
 */

describe("logging in as multiple client admin and check", () => {
  before(function () {
  ...
  specify("the edit access code page has the proper default states", () => {
    ...
    cy.get("[data-cy=client-disabled-dropdown]").should("be.visible")
