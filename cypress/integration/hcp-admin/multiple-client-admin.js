/*
 * This tests login in as a HCP multiple client admin
 * and checks the HCP-related columns.
 */

import { HCP_COLUMN_HEADERS } from "../../../src/utils/cypress-constants"

describe("logging in as HCP multiple client admin and check", () => {
  before(function () {
    cy.login(this.testData.users.multiple_client_admin_hcp)
