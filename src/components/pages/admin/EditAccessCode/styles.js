...
const FrequencySection = styled(FormSection)`
  padding-bottom: 28px;
`

const ActiveSection = styled(FormSection)`
  border-bottom: none;
  display: flex;
...
const BodyCopyNormal = styled.div`
  ${typography.bodyTextSmall};
`
...
const SaveAccessCodeButton = styled(Button)`
  margin: 0 0 0 auto;
  display: block;
  width: 12.188rem;
